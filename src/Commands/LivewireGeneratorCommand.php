...
abstract class LivewireGeneratorCommand extends Command
{
    ...
    {
        return app_path($this->_getNamespacePath($this->livewireNamespace) . Str::lower(Str::plural($name)) . ".php");
    }
    ...
    protected function _getViewPath($view)
    {
        ...
        return $this->makeDirectory(resource_path("/views/livewire/" . Str::lower(Str::plural($name)) . "/{$view}.blade.php"));
    }
